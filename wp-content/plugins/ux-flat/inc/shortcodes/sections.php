...
function uxf_section( $atts, $content = null ) {
	...
	?>
	<section class="<?php echo esc_attr($classes); ?>" id="<?php echo esc_attr($_id); ?>" <?php echo get_shortcode_inline_css( $css_gradient ); ?>>
		<div class="<?php echo esc_attr($classes_bg); ?>" <?php echo $parallax; ?> <?php echo get_shortcode_inline_css( $css_mask ); ?>>
    ...
    <style>
    <?php echo '#'.esc_attr($_id); ?> .effect-sliding li:nth-of-type(1),<?php echo '#'.esc_attr($_id); ?> .effect-sliding li:nth-of-type(2),<?php echo '#'.$_id; ?> .effect-sliding li:nth-of-type(3) {
