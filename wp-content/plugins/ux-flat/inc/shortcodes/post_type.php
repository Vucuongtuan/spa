<?php
// [uxf_posttype]
function shortcode_latest_from_uxf_posttype($atts, $content = null, $tag = '' ) {
  ...
  if($visibility == 'hidden') return;
	...
	$css_title_height = array(
        array( 'attribute' => 'min-block-size', 'value' => $title_height, 'unit' => 'px'),
  	);
...
while ( $recentPosts->have_posts() ) : $recentPosts->the_post();
		...
		?><div class="col <?php echo implode(' ', $col_class); ?>" <?php echo esc_attr($animate);?>>
			<div class="col-inner">
  					...
  					<div class="box-image <?php echo esc_attr($classes_image_depth); ?>" <?php echo get_shortcode_inline_css($css_args_img); ?>>
                        ...
                        <?php if($show_author == 'badge') { ?>
                            <div class="absolute no-click x5 y95 md-x5 md-y95 lg-x5 lg-y95">
                                <div class="author-box tag-label" style="border-radius:99px;">
                                    ...
                                    <?php if($show_avatar == 'visible') { ?>
                                        ...
                                        <div class="flex-col flex-grow badge-circle-inside is-bold">
                                            <?php the_author_meta( 'display_name' ); ?>
                                        </div>
                                    <?php } else { ?>
                                        <div class="flex-col flex-grow is-bold">
                                            <?php the_author_meta( 'display_name' ); ?>
                                        </div>
                                    <?php } ?>
                                    </div>
          ...
          <?php } ?>
					...
					<?php } ?>
					<<?php echo esc_attr($title_tag); ?> class="post-title is-<?php echo $title_size; ?> <?php echo $title_style;?>"  <?php echo get_shortcode_inline_css($css_title_height); ?>><?php the_title(); ?></<?php echo esc_attr($title_tag); ?>>
                    <div>
...
add_shortcode("uxf_posttype", "shortcode_latest_from_uxf_posttype");
