...
function flatsome_uxf_banner( $atts, $content = null ){
  ...
  <div class="banner <?php echo esc_attr($classes); ?>" id="<?php echo esc_attr($_id); ?>">
     ...
     <div class="banner-inner fill">
        <div class="banner-bg fill" <?php echo esc_attr($parallax); ?> <?php echo get_shortcode_inline_css( $css_gradient ); ?>>
            <div class="bg fill bg-fill <?php echo esc_attr($lazy_load); ?>"></div>
        ...
        <div class="banner-layers <?php if($container_width !== 'full-width') echo 'container'; ?>">
            <?php echo wp_kses_post($start_link); ?><div class="fill banner-link"></div><?php echo wp_kses_post($end_link); ?>
            <?php
            // Get Layers
