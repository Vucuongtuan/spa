  ...
  class UXF_TAX_IMG {
      ...
      public function add_category_image($taxonomy) {
          ...
          <div class="form-field term-group">
              <label for="_thumbnail_id"><?php _e('Featured Images'); ?></label>
              <input type="hidden" id="_thumbnail_id" name="_thumbnail_id" class="custom_media_url" value="">
              <div id="category-image-wrapper"></div>
              <p>
                  <input type="button" class="button button-secondary ct_tax_media_button" id="ct_tax_media_button" name="ct_tax_media_button" value="<?php _e('Choose Image'); ?>" />
      ...
      public function save_category_image($term_id) {
          if (isset($_POST['_thumbnail_id']) && '' !== $_POST['_thumbnail_id']) {
